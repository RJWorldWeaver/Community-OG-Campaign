/*////////////////////////This script comes pretty much directly from the LMao Lugaru xDD mod.

If you read this, be warned.

...
MNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNG
					  ...
					  _____						MNGMNGMNGMNGMNGMNGMNGMNGMNG
                   ,-'     `._ 					MNGMNGMNGMNGMNGMNGMNGMNGMNG
                 ,'           `.        ,-. 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
               ,'               \       ),.\ 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
     ,.       /                  \     /(  \; 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
    /'\\     ,o.        ,ooooo.   \  ,'  `-') 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
    )) )`. d8P"Y8.    ,8P"""""Y8.  `'  .--"' 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
   (`-'   `Y'  `Y8    dP       `'     / 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
    `----.(   __ `    ,' ,---.       ( 			MNGMNGMNGMNGMNGMNGMNGMNGMNG
           ),--.`.   (  ;,---.        ) 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
          / \O_,' )   \  \O_,'        | 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
         ;  `-- ,'       `---'        | 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
         |    -'         `.           | 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
        _;    ,            )          : 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
     _.'|     `.:._   ,.::" `..       | 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
  --'   |   .'     """         `      |`. 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
        |  :;      :   :     _.       |`.`.-'--.MNGMNGMNGMNGMNGMNGMNGMNGMNG
        |  ' .     :   :__.,'|/       |  \ 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
        `     \--.__.-'|_|_|-/        /   ) 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
         \     \_   `--^"__,'        ,    | 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
   -hrr- ;  `    `--^---'          ,'     | 	MNGMNGMNGMNGMNGMNGMNGMNGMNG
          \  `                    /      / 		MNGMNGMNGMNGMNGMNGMNGMNGMNG
           \   `    _ _          / 				MNGMNGMNGMNGMNGMNGMNGMNGMNG
            \           `       / 				MNGMNGMNGMNGMNGMNGMNGMNGMNG
             \           '    ,' 				MNGMNGMNGMNGMNGMNGMNGMNGMNG
              `.       ,   _,' 					MNGMNGMNGMNGMNGMNGMNGMNGMNG
                `-.___.---' 					MNGMNGMNGMNGMNGMNGMNGMNGMNG
												MNGMNGMNGMNGMNGMNGMNGMNGMNG
												MNGMNGMNGMNGMNGMNGMNGMNGMNG
MNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNG
MNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNGMNG
...
//include "../MACHINERY/dnk_ctcn.as" why not? just to suffer?
#include "menu_common.as"
#include "COGC2018\MNG_dialogue\MNGsDialogueScript.as" //NO!
#include "settings.as"
...
////////////
array<string> keysOfAddedParams;
/////////

void ReceiveMessage(string msg) { //boi
   ...
   /*  } else if(token == "dispose_level"){
    ...
    if(token == "reset"){
        Log(info,"dnklevel script received \"reset\"");
        dialogue.Init();
	...
	/* } else if (token == "mix"){
		...
		Log(error, "mixvalue: "+mix(1,10,atof(token_iter.GetToken(msg))));  */
//   ^  that was extremly useful

		 }else if(token == "txtmtrcs"){
			token_iter.FindNextToken(msg);
			TextMetrics mtrcs = GetTextAtlasMetrics(font_path, 10, 0, token_iter.GetToken(msg) );
			Log(error,"advance x: "+mtrcs.advance_x      );
			Log(error,"avance y: "+mtrcs.advance_y        );
			Log(error,"bounds x: "+mtrcs.bounds_x       );
			Log(error,"bounds y: "+mtrcs.bounds_y         );
			Log(error,"ascenderRatio: "+mtrcs.ascenderRatio);

			//i dont get textmetrics
			//NOW i do lol
	} else if (token == "set_param") {
		ScriptParams@ params = level.GetScriptParams();

		token_iter.FindNextToken(msg);
		string key = token_iter.GetToken(msg);
		string value = token_iter.FindNextToken(msg) ? token_iter.GetToken(msg) : "";

		if(params.HasParam(key)){
			params.SetString(key,value);
		}else{
			keysOfAddedParams.insertLast(key);
			params.AddString(key,value);
		}
	} else if (token == "remove_param") {
		ScriptParams@ params = level.GetScriptParams();
	...
	} else if (token == "clear_added_params") {
		ScriptParams@ params = level.GetScriptParams();
		for(uint i = 0; i<keysOfAddedParams.length(); ++i){
			if(params.HasParam(keysOfAddedParams[i])){
				params.Remove(keysOfAddedParams[i]);
			}
		}
  ...
  /*   }else if(token == "screen_message") {
   ...
   /*  } else if(token == "displayhud"){
		...
		//////////////need this for hackky choice-ESC-menu compatibility.
	} else if(token == "open_menu") {
			if(dialogue.waiting_for_choice && !menu_paused){
				level.Execute("	has_gui = false;
								toggle_gui = true;
								SetPaused(true);
								menu_paused = true;");
			}
			menu_paused = !menu_paused || level.GetBoolVar("draw_settings");
    } else {
...
void DrawGUI2() {
    EnterTelemetryZone("cutcn.Display2()");
    dialogue.Display2();
    LeaveTelemetryZone();
...
void DrawGUI3() {
 ...
 /////////////////////this somehow doesn't work, the mouse twitches, as if raw mouse input is off, and when i turn it off, it works.
	/* if(dialogue.has_cam_control && (dialogue.waiting_for_choice || EditorModeActive())){
		SetGrabMouse(false);
	} */
////////////alright in that case i'm gonna do hacky shit :)
	if(level.HasFocus() != dialogue.waiting_for_choice && !menu_paused){
		Log(error,"Executing on level to get SetGrabMouse to work \n setting var to "+(dialogue.waiting_for_choice ? "true" : "false"));
		level.Execute("has_gui = "+(dialogue.waiting_for_choice ? "true;" : "false;"));
	}else if((level.GetBoolVar("toggle_gui") && level.GetBoolVar("menu_paused"))){
		menu_paused = false;
	}
 //////////////this deals with annoying cam twitching IN dialogue PREVIEW bc the Querryintfunction function ignores custom levelscripts
 //this is probably the uglyest shit ever geez.
	 if(dialogue.HasCameraControl() != (level.GetIntVar("display_text_id") == 696969)){
		Log(error,"Executing on level to interact with cam.as \n setting var to "+(dialogue.HasCameraControl() ? "696969" : "0"));
		level.Execute("display_text_id = "+(dialogue.HasCameraControl() ? "696969" : "0")+";");
	}
 ...
 /////////////
	...
	*/
    ...
    while( imGUI.getMessageQueueSize() > 0 ) {
		...
		if(message.name == "dlg_choice"){
			dialogue.ReceiveMessage("dlg_choice "+message.getString(0));
		}
    ...
    if(paused == 0){
		if(DebugKeysEnabled() && GetInputPressed(controller_id, "4")){
			level.SendMessage("stop_editing_dialogue");
            level.SendMessage("edit_ctc");
        }
        ...
        EnterTelemetryZone("Update dnk_dialogue");
        dialogue.Update();
        LeaveTelemetryZone();
...
bool DialogueCameraControl() {
    return dialogue.has_cam_control; // this doesn't get ignored by aschar.as, why
}
