...
dictionary drika_element_names = {	{"Wait Level Message", 1},
									...
									{"Play Sound", 6},
									{"Go To Line", 7},
									{"On Character Enter Exit", 8},
									{"On Item Enter Exit", 9},
									{"Send Level Message", 10},
									{"Start Dialogue", 11},
									{"Set Object Parameter", 12},
									{"Set Level Parameter", 13},
									{"Set Camera Parameter", 14},
									{"Create Object", 15},
									{"Transform Object", 16},
									{"Set Color", 17},
									{"Play Music", 18},
									{"Set Character Parameter", 19},
									{"Display Text", 20},
									{"Display Image", 21},
									{"Load Level", 22},
									{"Check Character State", 23},
									{"Set Velocity", 24},
									{"Slow Motion", 25},
									{"On Input", 26},
									{"Set Morph Target", 27},
...
class DrikaElement{
	...
	void CreatePlaceholder(){
		placeholder_id = CreateObject("Data/Objects/COGC2018/DHS/drika_hotspot_cube.xml", false);
	...
	void DrawGizmo(Object@ target){
		...
		DebugDrawWireMesh("Data/Models/COGC2018/DHS/drika_gizmo_y.obj", gizmo_transform_y, mix(vec4(), vec4(0.0f, 0.0f, 1.0f, 0.15f), color_mult), _delete_on_update);
		DebugDrawWireMesh("Data/Models/COGC2018/DHS/drika_gizmo_x.obj", gizmo_transform_x, mix(vec4(), vec4(1.0f, 0.0f, 0.0f, 0.15f), color_mult), _delete_on_update);
		DebugDrawWireMesh("Data/Models/COGC2018/DHS/drika_gizmo_z.obj", gizmo_transform_z, mix(vec4(), vec4(0.0f, 1.0, 0.0f, 0.15f), color_mult), _delete_on_update);
	}
